...
usr_group_kl=15.82
# load_args="--model.load pretrained_ckpts/swinT/pretrain_15.29_cifar10/version_0/checkpoints/epoch=33-val-acc=0.966.ckpt"
...
model_args="--model.set_bn_eval True --model.use_sgd False --model.learning_rate 3e-4 --model.num_classes $num_classes --model.momentum 0 --model.anneling_steps 50 --model.scheduler_interval epoch" # --trainer.gradient_clip_val 2.0"
