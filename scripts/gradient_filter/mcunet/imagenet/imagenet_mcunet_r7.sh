...
logger_args="--logger.save_dir runs/mcunet/$dataset/gradfilt/r7"
...
model_args="--model.with_grad_filter True --model.filt_radius 7 --model.set_bn_eval True --model.use_sgd True --model.learning_rate 0.05 --model.lr_warmup 4 --model.num_classes $num_classes --model.momentum 0.9 --model.anneling_steps 90 --model.scheduler_interval epoch"
