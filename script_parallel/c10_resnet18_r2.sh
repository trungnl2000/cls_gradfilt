...
# R2
python trainer_cls.py ${common_args} --logger.exp_name finetune_all_r2_${usr_group_kl} --model.with_grad_filter True --model.num_of_finetune "all" --model.filt_radius 2
