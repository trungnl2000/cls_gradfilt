...
python trainer_cls.py --config trung_configs/cls/mcunet/finetune_all_r2.yaml ${common_args} --logger.exp_name finetune_all_r2_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config trung_configs/cls/mcunet/finetune_all_r4.yaml ${common_args} --logger.exp_name finetune_all_r4_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config trung_configs/cls/mcunet/finetune_all_r7.yaml ${common_args} --logger.exp_name finetune_all_r7_${usr_group_kl} --model.with_grad_filter True
