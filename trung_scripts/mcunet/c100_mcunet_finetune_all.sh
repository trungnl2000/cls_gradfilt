...
python trainer_cls.py --config trung_configs/cls/mcunet/finetune_all_r2.yaml ${common_args} --logger.exp_name finetune_all_${usr_group_kl} --model.with_grad_filter False